const Ren = {
  ...
  colorIcon() {
    return `<g fill="none"><circle cx="16" cy="16" r="16" fill="#001B3A"/><path d="M9.026 9.636l-.228-.374L6 10.872v-.244L15.743 5l.21.13.442.244.438.26-5.97 3.448-.227-.374-1.61.928zm0 3.545l-.228-.374L6 14.417v-.261l12.816-7.383.214.13.438.243.439.26-5.987 3.45-.21-.375-4.684 2.7zm0 1.772l-.228-.388L6 16.189v-.258L20.346 7.65l.21.13.442.261.438.246-5.987 3.447-.21-.373-6.213 3.592zm0 1.758l-.228-.374L6 17.947v-.243l15.875-9.159.21.115.44.259.44.245-5.936 3.433-.213-.376-7.79 4.49zm0 1.772l-.228-.373L6 19.72v-.244l17.404-10.05.229.127.42.246.442.26-5.937 3.433-.213-.391-9.319 5.382zm16.133-8.05l.326.195v.635l-6.927 3.984-.213-.374-9.319 5.383-.228-.374L6 21.492v-.243l18.934-10.946.225.13zM7.203 22.567l-.21-.13 18.492-10.67v1.251l-6.962 4.034-.226-.389-9.303 5.383-.229-.374-1.562.895zm11.094-4.131l-7.744 4.472-.226-.373-1.594.927-.21-.13 16.962-9.793v1.254l-6.962 4.034-.226-.391zm-8.035 5.904l-.213-.13 15.436-8.913v1.268l-6.962 4.017-.226-.374-6.215 3.595-.21-.39-1.61.927zm1.544.877l-.228-.112 13.907-8.036v1.269l-6.962 4.016-.226-.373-4.685 2.7-.211-.374-1.595.91zm1.302.765l12.377-7.14v1.268l-6.962 4.02-.226-.377-3.156 1.823-.21-.391-1.595.927-.228-.13zm1.757 1.008l-.213-.113 10.833-6.263v1.269l-6.962 4.019-.226-.391-1.612.942-.225-.373-1.595.91zm3.513-20.478l-5.985 3.45-.213-.374-3.154 1.82-.228-.373L6 12.645V12.4l11.272-6.524.228.13.439.262.439.243z" fill="#FFF"/></g>`;
  }
};
export default Ren;
