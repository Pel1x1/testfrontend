...
export function derive_seed(path, seed) {
    return derive_key(path, seed, undefined, true);
}
export function derive_seckey(path, seckey, chaincode) {
    return derive_key(path, seckey, chaincode, true);
}
export function derive_pubkey(path, pubkey, chaincode) {
    return derive_key(path, pubkey, chaincode, false);
}
export function derive_key(path, input_key, chain_code, is_private = false) {
...
export function generate_code(chain_code, chain_data) {
    const I = hmac512(chain_code, chain_data), IL = I.slice(0, 32), IR = I.slice(32);
    return [IL, IR];
}
export function encode_extkey(key_link, key_prefix) {
...
export function derive_extkey(keyhex, path = '') {
...
export function parse_extkey(keyhex) {
